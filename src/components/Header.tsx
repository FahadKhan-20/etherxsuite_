  ...
  return (
    <div className="h-12 flex items-center px-4 gap-4 text-black" style={{
      ...
      <div className="flex items-center gap-4 pl-6">
        ...
        {isEditingTitle ? (
          <input
            ...
            className="font-semibold text-lg bg-white/50 px-2 py-1 rounded-none border border-black/20 focus:outline-none focus:border-black/40"
            style={{ width: '200px', color: '#000000' }}
          />
        ) : (
          <div
            className="flex items-center gap-2 cursor-pointer hover:bg-black/5 px-2 py-1 rounded-none"
            onClick={() => setIsEditingTitle(true)}
            title="Click to rename"
          >
            <span className="font-semibold text-lg" style={{ color: '#000000' }}>{title}</span>
            <Edit2 className="w-4 h-4 opacity-60" style={{ color: '#000000' }} />
          </div>
        )}
      </div>
      ...
      <div className="ml-auto flex items-center gap-3">
        ...
        >
          <LayoutDashboard className="w-5 h-5" style={{ color: '#000000', transition: 'color 0.15s ease' }} />
          <span>Dashboard</span>
        </Button>
      </div>
    </div>
